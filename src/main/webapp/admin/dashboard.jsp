...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .success-banner { background: #ecfdf5; color: #065f46; border: 1px solid #a7f3d0; border-radius: 8px; padding: 12px 20px; margin-bottom: 20px; font-size: 13px; }
...
<div class="main-wrapper">
    ...
    <main class="content">
        ...
        <div class="success-banner">
            <strong>Saved:</strong>
            <% if ("doctor_added".equals(successParam)) { %>
                Doctor has been added to the database.
            <% } else if ("patient_added".equals(successParam)) { %>
                Patient has been added to the database.
            <% } else if ("receptionist_added".equals(successParam)) { %>
                Receptionist has been added to the database.
            <% } else { %>
        ...
        <div class="error-banner">
            ...
            <% } else if ("validation".equals(errorParam) && messageParam != null) { %>
                <%= messageParam %>
            <% } else if ("doctor_failed".equals(errorParam)) { %>
                Doctor could not be saved.
            <% } else if ("patient_failed".equals(errorParam)) { %>
                Patient could not be saved.
            <% } else if ("receptionist_failed".equals(errorParam)) { %>
                Receptionist could not be saved.
