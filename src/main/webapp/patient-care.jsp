...
<div class="dashboard-shell">
    ...
    <section class="panel card-pad" style="margin-top: 32px;">
        ...
        <div class="meta-grid" style="margin-top: 32px; align-items: stretch;">
            ...
            <div class="panel card-pad">
                ...
                <div class="meta-grid" style="grid-template-columns: 1fr; gap: 16px; align-items: stretch;">
