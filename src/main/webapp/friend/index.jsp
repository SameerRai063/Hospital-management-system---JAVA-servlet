...
<nav class="bg-white/90 dark:bg-slate-900/90 backdrop-blur-md font-['Manrope'] text-sm font-semibold tracking-tight docked full-width top-0 sticky z-50 border-b border-[#C8D9E6]/30 dark:border-slate-800 shadow-sm shadow-[#2F4156]/5">
    <div class="flex justify-between items-center w-full px-6 py-4 max-w-7xl mx-auto">
        ...
        <div>
            <a href="${pageContext.request.contextPath}/login.jsp" class="inline-block text-center bg-white text-[#2F4156] border border-[#2F4156] font-button text-[24px] px-6 py-3 rounded-full hover:bg-slate-50 scale-95 transition-transform shadow-sm">
                Login
            </a>
            <a href="${pageContext.request.contextPath}/register.jsp" class="inline-block text-center bg-[#2F4156] text-white font-button text-[24px] px-6 py-3 rounded-full hover:opacity-90 scale-95 transition-transform shadow-lg shadow-primary-container/10 ml-3">
                Create an Account
            </a>
        </div>
    </div>
...
<footer class="bg-slate-50 dark:bg-slate-950 font-['Manrope'] text-xs font-medium full-width mt-auto border-t border-[#C8D9E6] dark:border-slate-800 flat no shadows Focus: ring-2 ring-[#567C8D] ring-offset-2">
    <div class="flex flex-col md:flex-row justify-between items-center w-full px-8 py-12 max-w-7xl mx-auto gap-6 text-[#2F4156] dark:text-slate-300">
        ...
        <div class="text-slate-500 dark:text-slate-400">
            Â© ${year} ${hospitalName} Hospital Management. All rights reserved.
        </div>
    </div>
</footer>
</body></html>
