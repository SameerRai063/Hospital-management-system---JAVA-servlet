...
@WebServlet("/receptionists/doctors")
public class viewDoctorsReceptionistServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // 4. Forward to JSP
            RequestDispatcher rd = request.getRequestDispatcher("/receptionists/doctors.jsp");
