...
@WebServlet("/receptionists/patients")
public class ViewPatientsReceptionistServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/receptionists/patients.jsp").forward(request, response);
