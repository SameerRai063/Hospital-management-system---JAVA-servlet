...
@WebServlet("/receptionists/viewReceptionist")
public class viewReceptionistsReceptionistServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection con = DBConnection.getConnection()) {
            ...
            request.getRequestDispatcher("/receptionists/viewReceptionist.jsp").forward(request, response);
