...
@WebServlet("/receptionists/receptionists")
public class viewReceptionistReceptionist extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // 5. Forward to JSP
            RequestDispatcher rd = request.getRequestDispatcher("/receptionists/receptionists.jsp");
